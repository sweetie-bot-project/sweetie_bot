...
private:
  ...
  interactive_markers::MenuHandler::EntryHandle menu_entry_visible;
  interactive_markers::MenuHandler::EntryHandle menu_entry_new_id;
  interactive_markers::MenuHandler::EntryHandle menu_entry_to_nominal;
};
