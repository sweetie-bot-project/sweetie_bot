...
class GenerateStepSequence(EventState):
    '''
    Use saved sweetie_bot_gait_generator::MoveBase action to plan and execute movement. Action goal is stored on ROS parameter server in serialized form.
    ...
    def __init__(self, controller = 'gait_generator', trajectory_param = None, trajectory_ns = 'saved_msgs/move_base'):
