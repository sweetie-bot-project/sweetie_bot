...
-- data flow: aggregator_ref, kinematics_fwd -> dynamics_inv
depl:connect("aggregator_ref.out_joints_sorted", "dynamics_inv.in_joints_sorted", rtt.Variable("ConnPolicy"));
